...
{
    public class PictureReadRepository : BaseReadRepository<Guid, Picture>, IPictureReadRepository
    {
        public PictureReadRepository(AppDbContext context) : base(context)
        {
        }
    }
}
